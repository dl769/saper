...
function unHide(no){
    ...
    var no8=no+widthOfBoard+1;
        ...
        if (no%widthOfBoard == 1){//LEFT SIDE  
            ...
            $('#'+no2).html('<img src="'+otherFields[no2]+'.png">'); $('#'+no2).attr('name','c'); $('#'+no2).removeAttr('alt')//-8 
            $('#'+no3).html('<img src="'+otherFields[no3]+'.png">'); $('#'+no3).attr('name','c'); $('#'+no3).removeAttr('alt')//-7
            $('#'+no5).html('<img src="'+otherFields[no5]+'.png">'); $('#'+no5).attr('name','c'); $('#'+no5).removeAttr('alt')//1
            $('#'+no7).html('<img src="'+otherFields[no7]+'.png">'); $('#'+no7).attr('name','c'); $('#'+no7).removeAttr('alt')//8
            $('#'+no8).html('<img src="'+otherFields[no8]+'.png">'); $('#'+no8).attr('name','c'); $('#'+no8).removeAttr('alt')//9
        }
        
        if (no%widthOfBoard == 0)//RIGHT side
        {
            $('#'+no1).html('<img src="'+otherFields[no1]+'.png">'); $('#'+no1).attr('name','c'); $('#'+no1).removeAttr('alt')//-9
            $('#'+no2).html('<img src="'+otherFields[no2]+'.png">'); $('#'+no2).attr('name','c'); $('#'+no2).removeAttr('alt')//-8
            $('#'+no4).html('<img src="'+otherFields[no4]+'.png">'); $('#'+no4).attr('name','c'); $('#'+no4).removeAttr('alt')//-1
            $('#'+no6).html('<img src="'+otherFields[no6]+'.png">'); $('#'+no6).attr('name','c'); $('#'+no6).removeAttr('alt')//+7
            $('#'+no7).html('<img src="'+otherFields[no7]+'.png">'); $('#'+no7).attr('name','c'); $('#'+no7).removeAttr('alt')//+8
        }
        if(no%widthOfBoard !=0 && no%widthOfBoard!=1){
        $('#'+no1).html('<img src="'+otherFields[no1]+'.png">'); $('#'+no1).attr('name','c'); $('#'+no1).removeAttr('alt')
        $('#'+no2).html('<img src="'+otherFields[no2]+'.png">'); $('#'+no2).attr('name','c'); $('#'+no2).removeAttr('alt')
        $('#'+no3).html('<img src="'+otherFields[no3]+'.png">'); $('#'+no3).attr('name','c'); $('#'+no3).removeAttr('alt')
        $('#'+no4).html('<img src="'+otherFields[no4]+'.png">'); $('#'+no4).attr('name','c'); $('#'+no4).removeAttr('alt')
        $('#'+no5).html('<img src="'+otherFields[no5]+'.png">'); $('#'+no5).attr('name','c'); $('#'+no5).removeAttr('alt')
        $('#'+no6).html('<img src="'+otherFields[no6]+'.png">'); $('#'+no6).attr('name','c'); $('#'+no6).removeAttr('alt')
        $('#'+no7).html('<img src="'+otherFields[no7]+'.png">'); $('#'+no7).attr('name','c'); $('#'+no7).removeAttr('alt')
        $('#'+no8).html('<img src="'+otherFields[no8]+'.png">'); $('#'+no8).attr('name','c'); $('#'+no8).removeAttr('alt')
        }
    }
